...
export interface ApiDokumentDokument extends Struct.CollectionTypeSchema {
  collectionName: 'dokumenta';
  info: {
    displayName: 'Dokument';
    pluralName: 'dokumenta';
  ...
  attributes: {
    ...
    fajl: Schema.Attribute.Media<'files'>;
...
export interface ApiOdeljenjeOdeljenje extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'odeljenjas';
    singularName: 'odeljenje';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    istaknuta_slika: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::odeljenje.odeljenje'
    > &
      Schema.Attribute.Private;
    naziv: Schema.Attribute.String;
    ...
    smer: Schema.Attribute.String;
    trajanje: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiVestVest extends Struct.CollectionTypeSchema {
  collectionName: 'vests';
  info: {
    displayName: 'Vest';
    pluralName: 'vests';
    singularName: 'vest';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    datum_objave: Schema.Attribute.Date;
    istaknuta: Schema.Attribute.Boolean;
    kategorija: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::vest.vest'> &
      Schema.Attribute.Private;
